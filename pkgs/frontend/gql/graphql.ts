...
export enum EscrowedRoleShare_OrderBy {
  ...
  WorkspaceQuestAgentHatId = 'workspace__questAgentHatId',
...
export type Workspace = {
  ...
  owner: Scalars['String']['output'];
  questAgentHatId: Scalars['BigInt']['output'];
  quests: Array<Quest>;
...
export type Workspace_Filter = {
  ...
  owner_starts_with?: InputMaybe<Scalars['String']['input']>;
  owner_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  questAgentHatId?: InputMaybe<Scalars['BigInt']['input']>;
  questAgentHatId_gt?: InputMaybe<Scalars['BigInt']['input']>;
  questAgentHatId_gte?: InputMaybe<Scalars['BigInt']['input']>;
  questAgentHatId_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  questAgentHatId_lt?: InputMaybe<Scalars['BigInt']['input']>;
  questAgentHatId_lte?: InputMaybe<Scalars['BigInt']['input']>;
  questAgentHatId_not?: InputMaybe<Scalars['BigInt']['input']>;
  questAgentHatId_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  quests_?: InputMaybe<Quest_Filter>;
